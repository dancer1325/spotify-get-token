...
export class SpotifyService {
  ...
  headers2 = {
    'Authorization': 'Basic ODEyZjBkOWNlOGJjNDlmNGI1Y2E3OWRkOWRiNzhlNGI6Y2E0YWUzYjM4NzdmNDBlMWI0ZWUyYjE5NjBhYTk4MmQ='
    // ,
  ...
  constructor(private http: HttpClient) {
    ...
    this.http.post<any>(this.tokenUrl, this.tokenBody, {headers: this.headers2 } ).subscribe(data => {
  ...
  getQuery( query: string ) {
    ...
    const headers = new HttpHeaders({
      'Authorization': 'Bearer BQAKRQm6UKswq9g1NTWgDw0f0qUviSo0fNahJ6r8yq6yUCUv7R56WiWQT0RXoL_pmT1Ktzb3SiTah2TJMFs'
    });
